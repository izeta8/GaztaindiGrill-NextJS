...
import { Pause, Info, User, BarChart3 } from "lucide-react"; // Added Info, User, BarChart3 icons
import { getStepIcon, getStepDescription, truncate } from "@/utils"; // Added truncate
...
export function ProgramExecutionStatus({ handleCancelProgram, isConnected, grillIndex }: ProgramExecutionStatusProps) {
    ...
    const runningProgram = runningPrograms[grillIndex];
